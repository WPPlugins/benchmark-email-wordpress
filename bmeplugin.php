...
if ( !function_exists("widget_bme_listbuilder" ) ) {
  function widget_bme_listbuilder($args) {
    ...
    echo '<p><div style="float:left; padding-right:10px;width:80px;">Email </div><div style="float:left;"><input type="text" name="email" class="frm" value="' .  $prevemail . '" /></div></p>';
    echo '<p><div style="float:left; padding-right:10px;width:80px;padding-top:7px;">First Name </div><div style="float:left;"><input type="text" name="fname" class="frm" /></div></p>';
    echo '<p><div style="float:left; padding-right:10px;width:80px;padding-top:7px;">Last Name </div><div style="float:left;"><input type="text" name="lname" class="frm" /></div></p>';
    echo '<p><div style="float:left;padding-top:7px;"><input type="submit" name="subscribe" value="Subscribe" class="subscribe" /></div></p>';
    if ( $show_footer == 1 ) {
      echo '<p><div style="float:left;padding-top:7px;"><a href="http://www.benchmarkemail.com">Email marketing</a> by BenchmarkEmail</div></p>';
    }
    echo '</form>';
