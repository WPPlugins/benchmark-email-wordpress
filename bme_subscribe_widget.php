...
function widget_bme_listbuilder($args)
{
  ...
  echo '<p><div style="float:left;">Email </div><div style="float:left; padding-left:10px;"><input type="text" name="email" class="frm" value="' .  $prevemail . '" /></div></p>';
  echo '<p><div style="float:left;padding-top:7px;">First Name </div><div style="float:left; padding-left:10px;"><input type="text" name="fname" class="frm" /></div></p>';
  echo '<p><div style="float:left;padding-top:7px;">Last Name </div><div style="float:left; padding-left:10px;"><input type="text" name="lname" class="frm" /></div></p>';
